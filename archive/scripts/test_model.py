...
# ------------------ CONFIG ------------------
XML_PATH = "/Users/aaronthomas/Desktop/Engineering_Projects/Climbing Robot/assets/scene.xml"
SAVE_DIR = "./models"
MODEL_NAME = "/Users/aaronthomas/Desktop/Engineering_Projects/Climbing Robot/ppo_climbbot.zip"
...
def make_env(xml_path, seed=None, render_mode="human"):
    ...
    def _init():
        env = ClimbEnv(xml_path=xml_path, render_modes=render_mode, debug=False)
        env.reset(seed=seed)
        return env
    return _init
